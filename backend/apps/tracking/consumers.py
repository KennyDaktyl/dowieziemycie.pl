...
from .services import LIVE_GROUP, booking_group, update_driver_position
...
class DriverTrackConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data=None, bytes_data=None):
        ...
        payload, active_booking_id = await database_sync_to_async(update_driver_position)(
            self.driver, lat, lng, status_value
        )
